            ...
            <div class="col-md-5">
                ...
                <div class="w-100">
                    ...
                    <div class="w-100 d-flex justify-content-between">
                        <span class="rounded-0 btn-flat btn-sm btn-primary d-flex align-items-center  justify-content-between"><i class=" ">₱</i> <span class="ml-1"><?php echo number_format($price) ?></span></span>
