            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><?php echo date("Y-m-d",strtotime($row['date_in']))?></td>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Are you sure to delete this Appointment permanently?","delete_booking",[$(this).attr('data-id')])
		})
        $('.view_data').click(function(){
            uni_modal("Appointment Information","bookings/view.php?id="+$(this).attr('data-id'))
        })
		$('.table').dataTable();
	})
