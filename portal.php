...
<header class="masthead">
	...
	<a class="btn btn-primary btn-xl text-uppercase" href="#home">Find Therapy</a>

	<div class="text-1" style="padding-top: 2rem;">
		<h2 style="text-align: center; font-family: Arial Black; color: white;">Take the guesswork out of finding a great
			massage</h2>
		<p style="text-align: center; font-family: Arial Black; color: white;">ESPARIN makes it easy to find and book the
			best massage and bodywork suits for your preferred services</p>
	</div>
...
<section class="page-section bg-dark" id="home">
	<div class="container">
		<h2 class="text-center">Therapy</h2>
					...
					<div class="card w-100 rounded-0">
						...
						<div class="card-body">
							...
							<div class="w-100 d-flex justify-content-end">
								<a href="./?page=view_room&id=<?php echo md5($row['id']) ?>" class="btn btn-sm btn-flat btn-warning">View Therapy <i class="fa fa-arrow-right"></i></a>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="d-flex w-100 justify-content-end">
			<a href="./?page=rooms" class="btn btn-flat btn-warning mr-4">More Therapy <i class="fa fa-arrow-right"></i></a>
		</div>
	</div>
</section>
<!-- About-->
