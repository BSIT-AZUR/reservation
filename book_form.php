        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="date" value="" name="date_in" class="form form-control" min="<?php echo date('Y-m-d'); ?>" required>
                </div>
...
<script>
    ...
    function calc_total() {
        ...
        $('#total').text(parseFloat(grand_total).toLocaleString('en-US', {
            style: 'decimal',
            maximumFractionDigits: 2
        }))
        $('#room_sub_total').text(parseFloat(room_rate_sub).toLocaleString('en-US', {
            style: 'decimal',
            maximumFractionDigits: 2
        }))
    ...
    $(function() {
        $('[name="accom_id[]"]').each(function() {
            $(this).change(function() {
                ...
                $('#accom_total').text(parseFloat(accom_sub).toLocaleString('en-US', {
                    style: 'decimal',
                    maximumFractionDigits: 2
                }))
                calc_total()
